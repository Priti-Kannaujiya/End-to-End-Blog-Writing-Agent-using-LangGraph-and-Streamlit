...
# -----------------------------
BACKEND_COPY_PATH = Path(__file__).with_name("bwa_backend_copy.py")
spec = importlib.util.spec_from_file_location("bwa_backend_copy", BACKEND_COPY_PATH)
if spec is None or spec.loader is None:
    raise ImportError(f"Could not load backend copy from {BACKEND_COPY_PATH}")
bwa_backend_copy = importlib.util.module_from_spec(spec)
sys.modules["bwa_backend_copy"] = bwa_backend_copy
spec.loader.exec_module(bwa_backend_copy)
app = bwa_backend_copy.app
